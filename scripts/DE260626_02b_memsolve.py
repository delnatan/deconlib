"""Super-resolution deconvolution with memsolve and Cauchy ICF.
...
- Add CauchyICF as hidden->visible operator (same dimensions)
- Poisson likelihood, flat prior in hidden-space
- Solver: memsolve Bayesian MaxEnt

This is the Cauchy ICF variant of DE260626_02, using Cauchy distribution
with heavier tails than Gaussian for potentially better handling of
outliers and sharp features.
"""
...
output_file_hidden = "restored_DE260626_02b_memsolve_hidden.ims"
output_file_visible = "restored_DE260626_02b_memsolve_visible.ims"
...
# ICF OPERATOR
# =============================================================================
# CauchyICF: hidden -> visible (same dimensions as padded_visible_shape)
...
metadata_hidden = {
    ...
    "channels": [
        {"name": "Deconvolved (hidden-space, Cauchy ICF, with padding)"}
    ],
}
save_imaris(
...
metadata_visible = {
    "scale": visible_pixel_spacing,
    "channels": [
        {"name": "Deconvolved (visible-space, Cauchy ICF, with padding)"}
    ],
}
save_imaris(
